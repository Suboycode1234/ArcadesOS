all:
	...
	i686-elf-gcc -ffreestanding -m32 -Ikernel -c kernel/memory/paging.c -o paging.o
	...
	i686-elf-ld -T linker.ld -o kernel.elf boot.o main.o vga.o timer.o shell.o kmalloc.o pmm.o paging.o gdt.o idt.o isr_c.o isr_s.o pic.o keyboard.o
