...
QEMU (https://www.qemu.org/download/), MSYS2 (https://www.msys2.org/), and Vscode (optional if you want to make changes) ARE REQUIRED to launch this program! ALL COMMANDS ARE RUN IN MSYS2 UCRT64 TERMINAL
